...
namespace HR.API.Migrations
{
    ...
    [Migration("20221031034454_sintecnicoreformado")]
    partial class sintecnicoreformado
    {
            ...
            modelBuilder.Entity("HR.API.Data.Entities.Reclamo", b =>
                {
                    ...
                    b.HasOne("HR.API.Data.Entities.Material", null)
                        .WithMany("Reclamos")
                        .HasForeignKey("MaterialId");

                    b.HasOne("HR.API.Data.Entities.ReclamoType", "Tipo")
                        .WithMany("Reclamo")
